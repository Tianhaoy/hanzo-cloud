 ...
 * @Description:重写UserInfoTokenServices
 */
public class HanZoUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public HanZoUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
