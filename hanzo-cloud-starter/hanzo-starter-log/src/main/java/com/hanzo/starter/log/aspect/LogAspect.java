package com.hanzo.starter.log.aspect;
...
import com.hanzo.common.util.IPUtil;
import com.hanzo.common.util.RequestHolder;
import com.hanzo.common.util.ThrowableUtil;
import com.hanzo.common.util.TraceUtil;
import com.hanzo.starter.log.annotation.Log;
import com.hanzo.starter.log.event.LogEvent;
import com.hanzo.starter.log.util.SecurityUtil;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.hanzo.starter.log.annotation.Log)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        if (!url.contains("oauth") && !(url.contains("code"))){
            ...
            if (StringUtils.isNotBlank(SecurityUtil.getHeaderToken(request))) {
                //从上下文获取用户名
                userName = BaseUserContext.getUser().getUsername();
            }
        }
        //　封装SysLog
        ...
        commonLog.setIp(ip)
                ...
                .setTraceId(request.getHeader(HanZoConstants.HANZO_TRACE_ID))
